...
urlpatterns = [
    ...
    path('add/plaintiff/', add_plaintiff, name="add-plaintiff"),
    path('add/victim/<int:pl_id>', add_victim, name="add-victim"),
    path('register/testimony/<int:pl_id>/<int:vic_id>/', register_testimony, name="register-testimony"),
